...
!!! warning "You are in a maze of twisty little passages, all alike ..."

    There is no fully reliable way to parse arbitrary dates containing month
    names in a generic, locale-aware away. Don't be tempted to attempt this in a
    **docma** template. If you think you need to, you are either solving the
    problem the wrong way or solving the wrong problem.
